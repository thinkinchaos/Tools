...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=0.5, max_rotation_angle=30,
        ...
        self.equ1_rate = equ1_rate
        self.equ2_rate = equ2_rate

    def hisEqulColor1(self, img):
        # 将RGB图像转换到YCrCb空间中
    ...
    def _rotate_img_bbox(self, img, bboxes, angle=20, scale=1.):
    ...
    def dataAugment(self, img, bboxes):
        ...
        while change_num < 1:  # 默认至少有一种数据增强生效
            if random.random() > self.equ1_rate:  # 改变亮度2
                print('均衡化1')
                change_num += 1
                img = self.hisEqulColor1(img)
        ...
        print('------change num of this img_aug: ', change_num)
        return img, bboxes
...
if __name__ == '__main__':
    ...
    source_pic_root_path = './VOC2007/JPEGImages'
    source_xml_root_path = './VOC2007/Annotations'

    target_pic_root_path = './VOC20072/JPEGImages'
    target_xml_root_path = './VOC20072/Annotations'
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        ...
        for file in files:
            ...
            new_image_name = str(i) + '.png'
            cv2.imwrite(target_pic_root_path + '/' + new_image_name, img)
            generate_xml(new_image_name, coords, image_size, target_xml_root_path)
            i += 1
            ...
            while cnt < need_aug_num:
                ...
                new_image_name = str(i) + '.png'
                cv2.imwrite(target_pic_root_path + '/' + new_image_name, auged_img)
                generate_xml(new_image_name, coords, image_size, target_xml_root_path)
                i += 1
