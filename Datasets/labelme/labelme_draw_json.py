        ...
        for num, json_file in enumerate(self.jsonfile):
            ...
            for shape in shapes:
                ...
                if shape["label"] in self.class_ids:
                    pass
                if shape["label"] not in self.class_ids and shape["label"] == "guidaoxian":
...
labelme_json = glob.glob('D:/DATA/guijiao/done/guidao/*.json')
c = tococo(labelme_json, 'D:/DATA/guijiao/done/guidaoxian.json')
c.save_json()
